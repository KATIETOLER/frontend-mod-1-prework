...
// EXPLAIN:
// 0 1 2 is logged. This is because the variable is initialized at 0,
//the condition is that its at a place in the index that is less than the thrid,
//and lastly, the iteration is set to 3 so it will print out the indix from places 0-2
